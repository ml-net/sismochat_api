...
- CI/CD: GitHub Actions runs tests on Node 18 and 20; `JWT_SECRET` is provided from GitHub Secrets and must never be hardcoded. CHANGELOG: update as the last commit in the feature PR, just before merge. Then tag on main after merge.
